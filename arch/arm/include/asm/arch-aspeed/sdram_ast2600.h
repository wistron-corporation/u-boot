...
#define MCR30_MODE_REG_SEL_MASK		(0x7 << MCR30_MODE_REG_SEL_SHIFT)
#define MCR30_SET_MODE_REG		BIT(0)

#define MCR30_SET_MR(mr) ((mr << MCR30_MODE_REG_SEL_MASK) | MCR30_SET_MODE_REG)
...
#define MCR34_ODT_AUTO_ON		(0x1 << 9)
#define MCR34_ODT_EN			(0x1 << 8)
#define MCR34_RESETN_DIS		(0x1 << 7)
#define MCR34_MREQI_DIS			(0x1 << 6)
#define MCR34_MREQ_BYPASS_DIS		(0x1 << 5)
#define MCR34_RGAP_CTRL_EN		(0x1 << 4)
#define MCR34_CKE_OUT_IN_SELF_REF_DIS	(0x1 << 3)
#define MCR34_FOURCE_SELF_REF_EN	(0x1 << 2)
#define MCR34_AUTOPWRDN_EN		(0x1 << 1)
#define MCR34_CKE_EN			(0x1 << 0)

#define MCR38_RW_MAX_GRANT_CNT_RQ_SHIFT	16
#define MCR38_RW_MAX_GRANT_CNT_RQ_MASK	(0x1F << MCR38_RW_MAX_GRANT_CNT_RQ_SHIFT)
...
#define MCR50_RESET_ALL_INTR		(1 << 31)

#define SDRAM_CONF_SCRAMBLE		(0x1 << 8)
#define SDRAM_CONF_ECC_EN		(0x1 << 7)
#define SDRAM_CONF_DUALX8		(0x1 << 5)
#define SDRAM_CONF_DDR4			(0x1 << 4)
#define SDRAM_CONF_VGA_SIZE_SHIFT	2
#define SDRAM_CONF_VGA_SIZE_MASK	(0x3 << SDRAM_CONF_VGA_SIZE_MASK)
#define SDRAM_CONF_CAP_SHIFT		0
#define SDRAM_CONF_CAP_MASK		(0x3 << SDRAM_CONF_CAP_SHIFT)
...
#define SDRAM_REFRESH_PERIOD_ZQCS_MASK	(0xffff << SDRAM_REFRESH_PERIOD_ZQCS_SHIFT)
#define SDRAM_REFRESH_PERIOD_SHIFT	8
#define SDRAM_REFRESH_PERIOD_MASK	(0xff << SDRAM_REFRESH_PERIOD_SHIFT)
